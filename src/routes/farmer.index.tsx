...
export const Route = createFileRoute("/farmer/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Farmer dashboard for produce inventory and incoming orders.",
      },
  ...
  return (
    <div>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          label="Produce lines"
          value={<AnimatedNumber value={myProduce.length} />}
        ...
        />
        <StatCard
          label="Total kg listed"
          value={<AnimatedNumber value={totalKg} />}
      ...
      <section className="mt-8">
        <SectionTitle
          title="Your produce this week"
          action={
            <Link to="/farmer/produce" className="text-sm font-semibold text-clay">
              Manage inventory
            </Link>
          }
        />
      ...
      >
        ...
        <span className="min-w-0">
          ...
          <span className="block text-sm text-muted-foreground">
            Accept, prepare and mark orders as delivered.
          </span>
        </span>
